<template>
  <div class="promomats-v2">
    <h1>PromoMats Review and Approval Certification</h1>
    ...
    <div v-if="filteredQ.length" id="promomats">
...
<script>
import { promomats } from '~/static/promomats.json'

export default {
  name: 'PromoMatsReviewApprovalV2',
  data () {
    return {
      filter: '',
      questions: promomats
  ...
  head () {
    return {
      title:
        'PromoMats Review and Approval v2 - Veeva Certs | A morsecodemedia tool',
      meta: [
        {
          hid: 'ogtitle',
          property: 'og:title',
