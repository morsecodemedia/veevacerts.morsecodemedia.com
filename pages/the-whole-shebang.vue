<template>
  <div class="master">
    <h1>Get You Some Veeva Knowledge</h1>
...
export default {
  ...
  head () {
    return {
      title: 'The Whole Shebang - Veeva Certs | A morsecodemedia tool',
      meta: [
        {
          hid: 'ogtitle',
          property: 'og:title',
          content: 'The Whole Shebang - Veeva Certs | A morsecodemedia tool'
        },
        {
          hid: 'twtitle',
          name: 'twitter:title',
